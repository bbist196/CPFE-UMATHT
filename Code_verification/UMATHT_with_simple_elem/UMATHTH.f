...
!***********************************************************************      
  ...
  !    print *, "eqp", statev(1+2*ntens)
  !    print *, "eqpdot", statev(2+2*ntens)
...
!     Initialization
 ...
 !     print *, "props(2)", props(2)
      ...
      olds=stress
      oldpl=eplas
 !     write(*,*), "Compute the gradient of the hydrostatic stress"
!      write(*,*), "time", time(1)
...
! If using this code for research or industrial purposes, please cite:
! S. del Busto, C. Beteg\F3n, E. Mart\EDnez-Pa\F1eda. A cohesive zone 
...
! Emilio Mart\EDnez-Pa\F1eda (mail@empaneda.com)
